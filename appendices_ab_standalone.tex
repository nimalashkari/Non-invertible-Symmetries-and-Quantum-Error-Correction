...
In a general compact group $G$, we have a finite left-invariant Haar measure $d\mu_L(g)$ which allows us to study the group $G$ through the lens of measurable functions that live on it. The Haar measure allows us to define $L_p$-norms
\begin{align}
...
\begin{align}
    &\iota_\infty(f)=\sum_g g(h) e_g,\qquad e_g\equiv \ket{g}\bra{g}\nn\\
...
\begin{align}
    &\iota^\pm_\infty(f)=\sum_g g(h) e_g^\pm, \qquad e_g^+=e_g,\qquad  e_g^-=\ket{g^{-1}}\bra{g^{-1}}\nn\\
...
\begin{align}
    Z(\mathcal{L}^1(G))=\mathcal{L}(G)\cap \mathcal{L}(G)'
\end{align}
