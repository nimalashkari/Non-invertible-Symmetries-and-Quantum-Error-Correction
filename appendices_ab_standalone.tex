...
\end{align}
Note that $U_{g_1}U_{g_2}=U_{g_1g_2}$ implies that the multiplication of two functions $\delta(g-g_1)$ and $\delta(g-g_2)$ should result in $\delta(g_1g_2)$ which fixes the multiplication to be convolution:
\begin{align}
